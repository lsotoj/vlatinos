			...
			<Row class="justify-content-center">
				<Col xxl="3" md="6" sm="8">
					<div class="edit-profile">
						<div class="edit-profile__logos virtual-latinos-button-color">
							<img src="/img/virtual-latinos-png-logo.png" class="svg" alt="" />
						</div>
						<Card class="border-0">
							<!-- {#if loader}
							...
							<CardHeader>
								<div class="edit-profile__title">
									<h6 class="virtual-latinos-color">Sign in Virtual Latinos</h6>
								</div>
							</CardHeader>
							<CardBody>
								...
								<form on:submit|preventDefault={handleSubmit}>
									<div class="edit-profile__body">
										...
										>
											<Button
												type="submit"
												class="virtual-latinos-button-color btn btn-primary btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn "
											>
